...
drinks. Toronto has plenty of interesting bars and restaurants, and of course we only went to a couple of
them.
...
On
Saturday Lukas and I were acting like tourist by first going to the CN Tower and
then walking trough the city center. At some point we ended up at City
Hall square where some sort of performance was going on. We quickly noticed that this was only a repetition and
...
a quite an impressive show to celebrate `Toronto City Hall's 40th anniversary`_ .
