...
Other IDEs, such as Komodo, handle this by having a separate tab for
constants:

.. image:: images/komodo-vars.png

It is actually clever enough to create a new tab for every new context I come
up with, as they haven't hard coded it!
